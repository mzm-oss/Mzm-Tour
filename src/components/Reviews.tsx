        ...
        <section id="testimoni" className="py-10 scroll-mt-20 overflow-hidden">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-6">
                    ...
                    {/* Rating bar */}
                    <div className="flex items-center justify-center gap-3 bg-gray-50 border border-gray-100 rounded-2xl px-5 py-3 w-fit mx-auto">
                        <div className="flex gap-0.5">
                            {[1, 2, 3, 4, 5].map(s => (
                        ...
                        <span className="font-bold text-gray-800 text-sm">4.9 <span className="font-normal text-gray-400">/ 5.0</span></span>
                        <div className="w-px h-4 bg-gray-200" />
                        <span className="text-gray-400 text-xs">Berdasarkan 500+ ulasan jamaah terverifikasi</span>
                    </div>
                </div>
            </div>
