            ...
            <div className="relative min-h-screen flex items-center">
                ...
                <div className="relative z-10 w-full max-w-4xl mx-auto px-5 sm:px-8 lg:px-16 pt-20 pb-36 translate-y-16">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-4 text-center sm:text-left">
                        Wujudkan Perjalanan{" "}
                        <span style={{ color: "#008080" }}>Ibadah Suci</span>{" "}
                        Anda yang Bermakna
                    </h1>
                ...
                >
                    ...
                    >
                        {stats.map((stat, i) => (
                            <div key={i} className={`text-center ${i < stats.length - 1 ? "md:border-r md:border-gray-200" : ""}`}>
                                <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold" style={{ color: "#008080" }}>
                                    {stat.value}
                                </p>
