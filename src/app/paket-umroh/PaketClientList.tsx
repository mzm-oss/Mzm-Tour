...
import { IoAirplaneOutline, IoCalendarOutline, IoLocationOutline, IoTimeOutline, IoChevronForward, IoPricetagOutline } from "react-icons/io5";
...
function PaketCard({ paket, onImageClick, isHistory }: { paket: Paket; onImageClick: (src: string, alt: string) => void; isHistory?: boolean }) {
    ...
    const seatLabel = isFullBooked ? "Full Booked" : (totalSeat === null || totalSeat === 0 ? "Segera Tersedia" : `${totalSeat} Kursi Tersedia`);
