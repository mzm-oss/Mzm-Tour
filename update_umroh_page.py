...
filepath = r"c:\Users\Newt\Desktop\travel umroh\src\app\paket-umroh\page.tsx"
with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace "use client" in page.tsx with server fetch
# Remove all the client-side state and make it a server component
new_page = """import Image from "next/image";
...
print("Page updated to server component")
